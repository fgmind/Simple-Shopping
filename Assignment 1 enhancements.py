...
# Update History: 1.1 Enhanced assignment 1 with functions and and additional loops
...
def productMenu():                                      # Function to display product menu
    ...
    print ("\n0. Quit - This ends your session and prints your final bill!")

def itemCost(itemcost):                                 # function to return item cost
    return ("that will be " "$%0.2f" %itemcost)


while hasPaid == False:                                 # loop to ensure payment is made
    hasPaid = True                                      # unless specified loop will not repeat
    ...
    while quitshop == False:                            # Loop will keep going until quitshop == True
        ...
        productMenu()                                   # calls function to display menu
        ...
        if (choice == "1"):
            ...
            print(itemCost(3.50))                                                   # calls itemCost function and returns item cost
            ...
            quitshop = False                                                        # to ensure Menu loop repeats
            ...
            print ("\n"*10)                                             # makes screen less crowded with prompts
            ...
            while validOption == False:                                 # to ensure a valid option is chosen for cart clearing or payment
                validOption = True

                print ("")
                print ("would you like to clear cart and start again or exit and pay now?")
                print ("1. Clear cart and start again")
                print ("2. Pay now" )
                ...
                if (option == "1"):
                    print ("\n"*10)
                    print ("Your cart has been cleared of all previously selected items")   # resets selectitems & totalcost to 0
                    selecteditems = ""
                    totalcost = 0
                    quitshop = False                            # ensures menu loop repeats and user can choose products again
                    hasPaid = False

                elif (option == "2"):
                    print("")                                   # loops will exit as "quitShop" and "hasPaid" are still "True"

                else:
                    print ("\n"*10)
                    print ("Wrong option")
                    validOption = False                         # since invalid option, loop repeats
...
print ("")
print ("Total Cost:\t\t\t\t " + "$%0.2f" %(totalcost))                          # $%0.2f to display total cost with $ sign and 2 decimal points
print ("Your order has been processed and paid for")
